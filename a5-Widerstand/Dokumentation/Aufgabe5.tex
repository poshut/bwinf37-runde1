...
\lstinputlisting[language=Python]{code/widerstand_zusammenbauen.py}

\subsection{widerstand\_zeichnen}
\lstinputlisting[language=Python]{code/widerstand_zeichnen.py} 

\subsection{widerstandswert\_berechnen}
\lstinputlisting[language=Python]{code/widerstandswert_berechnen.py} 
